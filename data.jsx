...
window.PROJECTS = [
  ...
  },
  {
    slug: "jarvis",
    title: "Jarvis",
    kicker: "Local-first personal agent · archived",
    ...
    longBlurb: "Privacy-first local assistant with measured latency, retrieval, and hallucination gates. First project to cut when a tailored résumé needs space.",
    metrics: [
      { k: "mean", v: "0.42s" },
      { k: "p95", v: "1.15s" },
      { k: "Hit@5", v: "0.88" },
